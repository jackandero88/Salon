...
type Props = {};
export default class BusinessInfo extends Component<Props> {
  constructor(Props){
     super()
...
addOpeningSlotes(){
  ...
  render() {
    ...
    return (
      ...
      <Image style={{width: window.width, height: 150}} source={require('../images/signin/titleBusiness.png')}/>
      ...
      <FloatLabelTextInput
        placeholder={"What is the business phonr number?"}
        value={""}
      />
    </View>
    <View style = {styles.imageContainer}>
...
<Button rounded warning style = {{ marginTop : 30,  justifyContent: 'center',marginLeft : 30,width : window.width - 60,backgroundColor : '#4B4A92'}} onPress={() =>
